...
public class DelieverFragment extends Fragment {
    private static final int MFINISH = 226;
    private static final int MWHAT = 225;
    ...
    //控件定义
    private LinearLayout user_order_deliever_header, user_order_deliever_footer;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mMainActivity = (User_orderActivity) getActivity();
        view = inflater.inflate(R.layout.activity_user_deliever, null);
        initViews();//初始化控件
        //获取数据
        initData();
        //Nohttp请求
        ...
        public void onSucceed(int what, Response<String> response) {
            if (what == MWHAT) {
                ...
                try {
                    ...
                    JSONArray array = object1.getJSONArray("undelivered");
                    ...
                    //先判断应该显示哪个界面
                    if (mList.size() == 0) {
                        user_order_deliever_header.setVisibility(View.VISIBLE);
                    } else {
                        user_order_deliever_footer.setVisibility(View.VISIBLE);
                    }
    ...
    private void initViews() {
        ...
        user_order_deliever_header = (LinearLayout) view.findViewById(R.id.user_order_deliever_header);
        user_order_deliever_footer = (LinearLayout) view.findViewById(R.id.user_order_deliever_footer);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.user_order_deliever_recycle);
        //设置recycleview的布局管理
