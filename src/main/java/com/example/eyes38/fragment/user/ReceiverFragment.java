...
public class ReceiverFragment extends Fragment {
    ...
    //控件定义
    private LinearLayout user_order_receiver_header, user_order_receiver_footer;
        ...
        public void onSucceed(int what, Response<String> response) {
            if (what == MWHAT) {
                ...
                try {
                    ...
                    //先判断应该显示哪个界面
                    if (mList.size() == 0) {
                        user_order_receiver_header.setVisibility(View.VISIBLE);
                    } else {
                        user_order_receiver_footer.setVisibility(View.VISIBLE);
                    }
    ...
    private void initViews() {
        ...
        user_order_receiver_header = (LinearLayout) view.findViewById(R.id.user_order_receiver_header);
        user_order_receiver_footer = (LinearLayout) view.findViewById(R.id.user_order_receiver_footer);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.user_order_receiver_recycle);
        //设置recycleview的布局管理
