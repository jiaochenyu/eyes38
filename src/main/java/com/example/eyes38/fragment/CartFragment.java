...
public class CartFragment extends Fragment {
    ...
    private void initViews() {
        ...
        bottomRelativeLayout = (RelativeLayout) mView.findViewById(R.id.cart_bottom_rl);
        mCheckBoxAll = (CheckBox) mView.findViewById(R.id.checkboxAllGoods);  //底部全选框
        mJiesuanTV = (TextView) mView.findViewById(R.id.jiesuanButton); //结算按钮
        mTotalPriceTV = (TextView) mView.findViewById(R.id.allGoodsCountPrice); //总金额
    }
    ...
    private void initStates() {
        ...
        if (!Application.isLogin) {
            ...
            mCart_emptyAdapter = new Cart_EmptyAdapter(getActivity());
