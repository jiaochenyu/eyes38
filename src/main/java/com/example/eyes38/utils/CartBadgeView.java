 ...
 * @author Jeff Gilfelt
 */
public class CartBadgeView extends TextView {
	/// 徽章
	...
	public CartBadgeView(Context context, AttributeSet attrs) {
     ...
     */
	public CartBadgeView(Context context, View target) {
     ...
     */
	public CartBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public CartBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public CartBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
